...
// <ExitPolicy 
// banner_information={bannerInfo['exit_policy']} 

// sidebar_data={sidebarInfo['exit_policy']} 
// Active_section="Exit Policy"
// />} 
function ExitPolicy({banner_information,  sidebar_data, Active_section}) {
  return (
    <>
    ...
    {/* <Sidebar expandedPolicyName={Active_section} sidebar_data={sidebar_data["exit_policy"]}/> */}
