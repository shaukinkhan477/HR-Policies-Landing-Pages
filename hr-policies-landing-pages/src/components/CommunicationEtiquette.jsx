...
import ProfessionalLanguageImage from '../assets/professional_lang.jpg';
import ResponseTimesImage from '../assets/response_time.jpg';
import CulturalSensitivityImage from '../assets/cultural_sensitivity.jpg';
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div className="bg-white p-6 rounded-lg shadow hover:shadow-lg transition-shadow">
          <div className="flex items-center mb-4">
            ...
            <h3 className="text-xl font-bold text-indigo-600">Professional Language</h3>
          </div>
          <img
          ...
          <p className="text-gray-600">
            Maintain a professional tone in all communications. Avoid slang and informal expressions.
          </p>
        </div>
        ...
        <div className="bg-white p-6 rounded-lg shadow hover:shadow-lg transition-shadow">
          <div className="flex items-center mb-4">
            ...
            <h3 className="text-xl font-bold text-indigo-600">Response Times</h3>
          </div>
          <img
        ...
        <div className="bg-white p-6 rounded-lg shadow hover:shadow-lg transition-shadow">
          <div className="flex items-center mb-4">
            ...
            <h3 className="text-xl font-bold text-indigo-600">Cultural Sensitivity</h3>
          </div>
          <img
